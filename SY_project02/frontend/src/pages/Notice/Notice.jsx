...
import {
    ...
    NIP,
    NIPA,
    NIPInput, NNLFirst, NNoticeList, NPA, NPAClicked, NPagination, NPANext, NPLi, NPLNA, NPLNAImg, NPLNext, NPUl,
    NTable, NTbody, NTBTd, NTBTDLA, NTBTDLeft, NTBTr, NTh, NThead,
    NTIH2,
    NTIImg,
    NTInner,
    NTitleBox, NTr
