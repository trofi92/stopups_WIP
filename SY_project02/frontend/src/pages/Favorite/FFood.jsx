import {
    ...
    FCDTHead1,
    FCDTHTr1,
    FCDTColgroup, FCDTHTh1, FCDTHThDiv1, FCDTHThDInput1, FCDTHTbody1, FCDTHTbodyTd1, FCDTHTbodyTr1, FCDTHTbodyTdOK
            ...
            <FCDArticle1>
                <FCDFieldset1>
                    <FCDTable1>
                        ...
                        <FCDTHTbody1>
                            {/*데이터 없을 때*/}
                            <FCDTHTbodyTd1 colSpan={6}>데이터가 없습니다.</FCDTHTbodyTd1>
                        </FCDTHTbody1>
                    </FCDTable1>
                </FCDFieldset1>
            </FCDArticle1>
