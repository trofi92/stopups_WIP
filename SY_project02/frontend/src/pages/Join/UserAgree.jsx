                        ...
                        <styled_JoinAB.ABSIBP>
                            <div>
                                <div className="privacy_cont">
                                    <p className="mb15">
                                        본인은 스탑없으 코리아를 운영하는 주식회사 에스씨케이컴퍼니(이하 '회사'라 합니다)가 제공하는 회원 서비스(이하 ‘서비스’라 합니다)를 이용하기
                                        ...
                                        <li>
                                            ...
                                            <table className="vod_tb_ag mb20 mt10">
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="taLeft">성명, 생년월일, 성별, 아이디, 비밀번호, 휴대전화번호, E-Mail, DI
                                                        (Duplication information), 아이핀번호
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"><span className="fontBold">목적</span></th>
                                                    <td> - 회원가입(홈페이지. 스탑없으 리워드), 본인확인<br/>
                                                        - 서비스 제공 및 개선<br/>
