    ...
    return (
        <>
            <ABox>
                        ...
                        <ABSIBP>
                            <div>
                                <div class="privacy_cont">
                                    ...
                                    <p class="mb15 fontBold underLine">※ 귀하께서는 개인정보 수집·이용에 대한 동의를 거부하실 수 있으나, 동의를 거부하실
                                        ...
                                        <li>
                                            ...
                                            <table class="vod_tb_ag mb20 mt10">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="taLeft">성명, 생년월일, 성별, 아이디, 비밀번호, 휴대전화번호, E-Mail, DI
                                                        (Duplication information), 아이핀번호
                                                    </td>
                                                </tr>
                                                <tr>
               ...
               이용기간</span></th>
                                                    <td class="pointFont"><span class="underLine">회원 탈퇴 시 즉시 파기(단, 반복 재가입 등의 방법을 이용한 서비스 부정이용 방지를 위해 이름, ID, DI, 성별, 생년은 탈퇴 후 30일 보관) 또는 관계법령에 의한 별도 보존기간</span> (2.
